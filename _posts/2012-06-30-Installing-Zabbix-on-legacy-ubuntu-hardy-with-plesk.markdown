...
intro: "<img alt='pain-in-the-ass' src='http://barkingcode.peterhost.fr/img/covers/2012-06-30-zabbix-ubuntu-hardy-plesk.jpg'/> Installing latest version of Zabbix on Legacy Ubuntu with Plesk <strong>on top of it all</strong> is, yes you've guessed it, a real pain in the ass.<br /><br /><strong>Use Case:</strong> You boss wants you to do it ! You have no choice, you need to use Awesome Zabbix on that old hosted Plesk Server. But we won't settle for less than Zabbix 2.0, no way !"
---
{% include JB/setup %}
